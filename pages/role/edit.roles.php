...
if (isset($_SESSION['role_updated'])) {
    $modalType = 'success';
    $modalMessage = 'Role successfully updated!';
    unset($_SESSION['role_updated']);
} elseif (isset($_SESSION['role_exist'])) {
    $modalType = 'warning';
    $modalMessage = 'Role already exists!';
...
<head>
    ...
    <title>Alumni Tracer | Edit Role</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card card-primary">
                    ...
                    <form class="form" action="userData/ctrl.edit.roles.php?role_id=<?php echo $role_id;?>" method="POST" >
                    <?php
